...
const Exit = () => {
  ...
  const exitServices = [
    {
      ...
      description: "Comprehensive valuation analysis to maximize your business worth and identify value drivers.",
      benefits: ["Professional valuation report", "Value optimization strategies", "Market positioning analysis"]
    },
    {
      ...
      benefits: ["Custom exit roadmap", "Tax optimization", "Risk mitigation planning"]
    },
    {
      icon: <Award size={32} />,
  ...
  const exitOptions = [
    ...
    },
    {
      ...
      description: "Transition to employee ownership through ESOP or similar",
  ...
  return (
    <div className="min-h-screen">
      <SEOHelmet 
        title="Business Exit Planning Services | Maximize Your Business Sale | Norivane"
        description="Expert business exit planning and valuation services. Maximize your business sale value with strategic exit planning. 3x higher valuations achieved."
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl mb-8 text-gray-200 leading-relaxed">
                Ready to sell? We help you maximize your business value and navigate 
                the complex exit process. From valuation optimization to deal closure, 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-medium-grey max-w-3xl mx-auto">
              ...
              the path that maximizes value and aligns with your objectives.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-medium-grey mb-8 leading-relaxed">
                ...
                is crucial for maximizing your exit value. We analyze every aspect 
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto text-gray-200">
              Your business represents years of hard work. Let us help you maximize 
