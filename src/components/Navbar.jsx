          ...
          <div className="md:hidden bg-white border-t border-gray-200">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <button
                ...
                className="block mx-3 mt-4 bg-teal text-white px-6 py-2 rounded-full font-semibold text-center hover:bg-teal/90 transition-colors duration-200 w-[calc(100%-1.5rem)]"
              >
                Book Consultation
              </button>
            </div>
